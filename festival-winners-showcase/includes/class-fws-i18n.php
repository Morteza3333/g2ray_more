...
class FWS_i18n {
	...
	public function register_post_types() {
		$labels = array(
			'name'                  => _x( 'برندگان جشنواره', 'Post Type General Name', 'festival-winners-showcase' ),
			'singular_name'         => _x( 'برنده جشنواره', 'Post Type Singular Name', 'festival-winners-showcase' ),
			'menu_name'             => __( 'برندگان جشنواره', 'festival-winners-showcase' ),
			'name_admin_bar'        => __( 'برنده جشنواره', 'festival-winners-showcase' ),
		...
		$args = array(
			'label'                 => __( 'برنده جشنواره', 'festival-winners-showcase' ),
			'description'           => __( 'مدیریت برندگان جشنواره عکاسی', 'festival-winners-showcase' ),
			'labels'                => $labels,
			'supports'              => array( 'title', 'editor', 'thumbnail' ),
			'hierarchical'          => false,
			'public'                => true,
			'show_ui'               => true,
			'show_in_menu'          => false, // Handled by custom admin page
			'menu_position'         => 5,
		...
		// Register Taxonomy
		$tax_labels = array(
			'name'                       => _x( 'دسته‌بندی‌های جشنواره', 'Taxonomy General Name', 'festival-winners-showcase' ),
			'singular_name'              => _x( 'دسته‌بندی جشنواره', 'Taxonomy Singular Name', 'festival-winners-showcase' ),
			...
			'separate_items_with_commas' => __( 'جدا کردن موارد با کاما', 'festival-winners-showcase' ),
			'add_or_remove_items'        => __( 'افزودن یا حذف موارد', 'festival-winners-showcase' ),
			'choose_from_most_used'      => __( 'انتخاب از پرکاربردترین‌ها', 'festival-winners-showcase' ),
		...
		register_taxonomy( 'winner_category', array( 'winner_entry' ), $tax_args );
	}
}
